...
export default function Encabezado() {
  ...
  return (
    <>
      <header className="encabezado">
        <div className="encabezado-inner">
          <div className="encabezado-right">
            {/* Mostrar control sólo en la página de productos (botón ahora renderizado fuera del header) */}
      ...
      {/* BOTÓN ABAJO DEL HEADER (zona gris) */}
      {showMobileMenuControl && (
        <button
          className={`mobile-hamburger bubble hamburger-btn outside${menuOpen ? " open" : ""}`}
